...
<tr>
    <th  bgcolor="lightblue" style="font-size:18px;">رقم الفاتورة</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->invoice_number }}</td>
    <th style="font-size:18px;" bgcolor="lightblue">تاريخ الاصدار</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->invoice_date }}</td>
</tr>
<tr>
    <th style="font-size:18px;" bgcolor="lightblue">المنتج</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->product }}</td>
    <th style="font-size:18px;" bgcolor="lightblue">القسم</th>
    <td style="font-size:18px;" bgcolor="pink">{{$invoice->section->section_name}}</td>
    </tr>
    <tr>
    <th style="font-size:18px;" bgcolor="lightblue" >تاريخ الاستحقاق</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->Due_date }}</td>
    <th style="font-size:18px;" bgcolor="lightblue">الخصم</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->discount}}</td>
    </tr>
       <tr>
    <th style="font-size:18px;" bgcolor="lightblue">نسبة الضريبة</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->rate_vat }}</td>
    <th style="font-size:18px;" bgcolor="lightblue">قيمة الضريبة</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->value_vat}}</td>
    </tr>
    <tr>
    <th style="font-size:18px;" bgcolor="lightblue">مبلغ العمولة</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->amount_Commission }}</td>
    <th style="font-size:18px;" bgcolor="lightblue">مبلغ التحصيل</th>
    <td style="font-size:18px;" bgcolor="pink">{{ $invoice->amount_collection}}</td>
    </tr>
    <tr>
     <th style="font-size:18px;" bgcolor="lightblue">ملاحظات</th>
     <td style="font-size:18px;" bgcolor="pink">{{ $invoice->note }}</td>
     <th style="font-size:18px;" bgcolor="lightblue">الاجمالي</th>
     <td style="font-size:18px;" bgcolor="pink">{{ $invoice->total }}</td>
    </tr>
<tr>
    <th style="font-size:18px;" bgcolor="lightblue">المستخدم</th>
    <td style="font-size:18px;" bgcolor="pink">{{ username()  }}</td>
    <th style="font-size:18px;" bgcolor="lightblue">الحالة</th>
    <td>
