				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="<?php echo e(url('/' . $page='editprofile')); ?>">المنتجات</a></li>
						</ul>
					</li>
...
<!-- main-sidebar -->
<?php /**PATH /home/mohamed/Documents/Projects/Laravel/Fatorah/resources/views/layouts/main-sidebar.blade.php ENDPATH**/ ?>