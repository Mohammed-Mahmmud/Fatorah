...
<div class="alert alert-success alert-dismissible fade show" role="alert">
	<strong><?php echo e(session()->get('done')); ?></strong>
	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		<span aria-hidden="true">&times;</span>
	</button>
</div>
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                    ...
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                       ...
                                                       data-description="<?php echo e($x->description); ?>" data-toggle="modal" href="#exampleModal2"
                                                       title="تعديل"><i class="las la-pen"></i></a>

                                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                       data-id="<?php echo e($x->id); ?>" data-section_name="<?php echo e($x->section_name); ?>" data-toggle="modal"
